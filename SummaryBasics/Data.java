...
public class Data {
	...
	static Member[] members = new Member[] { new Member("Alice", 1, 2), new Member("Bob", 2, 1), new Member("Charlie", 3, 0),
			new Member("Diana", 4, 1), new Member("Eve", 5, 0) };
	static Loan[] loans = new Loan[] {
            new Loan("Alice", "Advanced Java", LocalDate.of  (2024,01,15)),
